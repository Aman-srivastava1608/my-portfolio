export const projectsData = [
    ...
    },
    {
        ...
        description: 'Developed a complete Flutter-based e-commerce application with Firebase as the backend. Added features such as product listings, add-to-cart functionality, order processing, and user authentication.',
        tools: ['Flutter', 'Firebase', 'Dart', 'Cloud Firestore', 'Firebase Auth'],
